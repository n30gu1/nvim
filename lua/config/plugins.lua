  ...
  },
  {
    ...
    config = function()
      require("presence").setup({
        ...
        file_explorer_text  = "Browsing a file",              -- Format string rendered when browsing a file explorer (either string or function(file_explorer_name: string): string)
        ...
        workspace_text      = "Working on a workspace",            -- Format string rendered when in a git repository (either string or function(project_name: string|nil, filename: string): string)
